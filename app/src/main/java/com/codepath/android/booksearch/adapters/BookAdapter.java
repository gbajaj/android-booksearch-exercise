...
public class BookAdapter extends ArrayAdapter<Doc> {
    // View lookup cache
    ...
    public BookAdapter(Context context, ArrayList<Doc> aBooks) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final Doc book = getItem(position);
        ...
        viewHolder.tvAuthor.setText(book.getAuthorName().get(0).toString());
